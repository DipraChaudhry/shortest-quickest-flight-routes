...
;( function( $, window, document, undefined ) {
    ...
    var pluginName = "twidget",
        defaults = {
            ...
            localization: {
                ...
                avia_submit_domain : 'results.html'
            }
        },
        // globals
        date = new Date(),
    ...
    $.extend( Plugin.prototype, {
        ...
        widget_html: function() {
            ...
            '                <div class="twidget-header" >'+
            '                    <span class="twidget-flight-li">Airline Booking</span>'+
            '                    <span class="twidget-title">'+_this.settings.localization.avia_logo_caption+'</span>'+
            '                </div>'+
